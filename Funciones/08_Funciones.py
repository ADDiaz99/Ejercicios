#Escribir una función que reciba una muestra de números en una lista y devuelva un diccionario con
...
def estadistica(numeros):
    ...
    diccionario = {'media': media,'varianza': varianza,'desviacion': desviacion,}
